...
export default function ToMakeItem({ recipe_id, navigation, updateRecipes }){
    ...
    const handleUnsaveRecipe = async() => {
        ...
        await DataFetcher.unsaveRecipe(user_id, recipe_id, 'saved_recipes');
        await updateRecipes();
    }
        ...
        <View>
            <TouchableOpacity style={styles.headerContainer} onPress={() => setCollapsed(!collapsed)}>
                ...
                <View style={styles.linkContainer}>
                    ...
                    <Pressable onPress={() => handleUnsaveRecipe()}>
